                ...
                <div className='steps flex lg:flex-col justify-center lg:items-center py-8'>
                    {
                      steps.map((item, i) => (
                        <div key={i} className='flex py-5 lg:w-40'>
                                <div className={`${currentIndex === i ? 'bg-white text-[#921445]' : ''} w-[35px] text-center text-white flex justify-center items-center mt-1 border h-[35px] rounded-full me-2`}>{i + 1}</div>
